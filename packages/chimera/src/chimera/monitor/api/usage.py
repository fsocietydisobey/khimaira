...
Reads the tail of `~/.local/state/chimera/usage.jsonl` lazily on each
request — fast enough at chimera-scale (a heavy day = ~10k lines, ~2MB).
...
from chimera.usage import log_file_path
