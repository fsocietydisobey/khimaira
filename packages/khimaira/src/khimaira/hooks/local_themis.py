...
Imports are intentionally lazy. A machine may install khimaira without the Themis
package, and each hook must be able to catch that import failure and fail open.
This function likewise does not catch rule-loading or evaluation errors; callers
at the hook boundary decide and diagnose their fail-open behavior.
"""
