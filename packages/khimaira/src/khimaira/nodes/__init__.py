"""Node factories for all KHIMAIRA patterns."""
...
from khimaira.nodes.balanced.integration_gate import build_integration_gate_node
from khimaira.nodes.balanced.retry_controller import build_retry_controller_node
...
# Shared
from khimaira.nodes.gemini_assist import build_gemini_assist_node
from khimaira.nodes.human_review import build_human_review_node

# HVD (Hypervisor Daemon)
from khimaira.nodes.hypervisor_dispatcher import build_hypervisor_dispatcher_node
from khimaira.nodes.pipeline.architect import build_architect_node
from khimaira.nodes.pipeline.critic import build_critic_node
from khimaira.nodes.pipeline.implement import build_implement_node
from khimaira.nodes.pipeline.research import build_research_node
...
from khimaira.nodes.supervisor import build_supervisor_node
from khimaira.nodes.swarm.aggregator import build_swarm_aggregator_node

# PDE (Parallel Dispatch Engine)
from khimaira.nodes.swarm.task_decomposer import build_swarm_decomposer_node
from khimaira.nodes.swarm.worker import build_swarm_worker_node
...
from khimaira.nodes.validator import build_validator_node
