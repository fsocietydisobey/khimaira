...
Database lives at ~/.local/share/khimaira/acl_registry.db.
"""
...
# Built-in components extracted from existing KHIMAIRA code
BUILTIN_COMPONENTS: dict[str, dict[str, str | list[str]]] = {
    "database": {
        "module": "khimaira.core.memory",
